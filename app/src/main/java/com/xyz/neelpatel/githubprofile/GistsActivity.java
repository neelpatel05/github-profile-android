...
public class GistsActivity extends AppCompatActivity {
    ...
    private class JsonTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(GistsActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            LinearLayout ll = (LinearLayout) findViewById(R.id.linear_layout_following);
            ...
            for (int i = 0; i < jsonresult.length(); i++) {
                t[i] = new TextView(GistsActivity.this);
                try {
                    t[i].setText("Filename : " + jsonresult.getJSONObject(i).getJSONObject("files").getString("filename") + "\n\n" + "Language : " + jsonresult.getJSONObject(i).getJSONObject("files").getString("language" + "\n\n" + "Type : " + jsonresult.getJSONObject(i).getJSONObject("files").getString("type")));
