...
public class OrganizationsActivity extends AppCompatActivity {
    ...
    private class JsonTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(OrganizationsActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            LinearLayout ll = (LinearLayout) findViewById(R.id.linear_layout_organizations);
            ...
            for (int i = 0; i < jsonresult.length(); i++) {
                t[i] = new TextView(OrganizationsActivity.this);
                try {
                    t[i].setText("Name : " + jsonresult.getJSONObject(i).getString("login") + "\n\n" + "Description : " + jsonresult.getJSONObject(i).getString("description"));
